...
class TestSM2Algorithm:
    from tutor_app.core.sm2_scheduler import compute_sm2

    def test_perfect_recall_first_rep(self):
        from tutor_app.core.sm2_scheduler import compute_sm2, FIRST_INTERVAL
    ...
    def test_perfect_recall_second_rep(self):
        from tutor_app.core.sm2_scheduler import compute_sm2, SECOND_INTERVAL
    ...
    def test_ef_floor(self):
        from tutor_app.core.sm2_scheduler import compute_sm2, MIN_EASE_FACTOR
...
class TestSM2Scheduler:
    ...
    def populated_scheduler(self, scheduler):
        from tutor_app.core.sm2_scheduler import KnowledgeItem
...
class TestSemanticChunker:
    @pytest.fixture
    def chunker(self):
        from tutor_app.core.rag_pipeline import SemanticChunker
...
class TestFAISSIndex:
    ...
    def sample_data(self):
        from tutor_app.core.rag_pipeline import Chunk, EMBEDDING_DIM
        n = 20
        chunks = [
    ...
    def test_build_and_search(self, sample_data):
        from tutor_app.core.rag_pipeline import FAISSIndex, EMBEDDING_DIM, SIMILARITY_THRESHOLD
    ...
    def test_empty_index_returns_empty(self):
        from tutor_app.core.rag_pipeline import FAISSIndex
        idx = FAISSIndex()
...
class TestRAGPipeline:
    ...
    def pipeline(self, tmp_path):
        from tutor_app.core.rag_pipeline import RAGPipeline, EMBEDDING_DIM
    ...
    def test_build_prompt_under_token_limit(self, pipeline):
        from tutor_app.core.rag_pipeline import MAX_PROMPT_TOKENS
        docs = [
            {
    ...
    def test_require_loaded_raises(self, tmp_path):
        from tutor_app.core.rag_pipeline import RAGPipeline
...
class TestConflictResolver:
    @pytest.fixture
    def resolver(self):
        from tutor_app.sync.sync_layer import ConflictResolver
...
class TestIntegration:
    ...
    def app_components(self, tmp_path):
        from tutor_app.core.rag_pipeline import RAGPipeline, EMBEDDING_DIM
        from tutor_app.core.sm2_scheduler import SM2Scheduler, KnowledgeItem
        from tutor_app.core.inference_engine import InferenceEngine
        ...
        from tutor_app.core.inference_engine import GenerationResult
